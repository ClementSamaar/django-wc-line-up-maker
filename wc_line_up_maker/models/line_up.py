...
class LineUp(models.Model):
    ...
    creator = models.ForeignKey(to=User, on_delete=models.CASCADE, null=False, blank=False, related_name='line_up')
    squad = models.ForeignKey(to=Squad, on_delete=models.CASCADE, null=False, blank=False, related_name='line_up')
